...
void Pintura::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->colorCambiado((*reinterpret_cast<std::add_pointer_t<QColor>>(_a[1]))); break;
        case 1: _t->grosorCambiado((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->statusMessage((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Pintura::*)(const QColor & )>(_a, &Pintura::colorCambiado, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Pintura::*)(int )>(_a, &Pintura::grosorCambiado, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Pintura::*)(const QString & )>(_a, &Pintura::statusMessage, 2))
            return;
    }
}
...
// SIGNAL 0
void Pintura::colorCambiado(const QColor & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Pintura::grosorCambiado(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Pintura::statusMessage(const QString & _t1)
{
