...
template <> constexpr inline auto Pantalla::qt_create_metaobjectdata<qt_meta_tag_ZN8PantallaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'solicitudCambioPantalla'
        QtMocHelpers::SignalData<void(const QString &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 3 },
        }}),
        // Signal 'eventoRegistrado'
...
void Pantalla::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->solicitudCambioPantalla((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->eventoRegistrado((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Pantalla::*)(const QString & )>(_a, &Pantalla::solicitudCambioPantalla, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Pantalla::*)(const QString & )>(_a, &Pantalla::eventoRegistrado, 1))
            return;
    }
}
...
// SIGNAL 0
void Pantalla::solicitudCambioPantalla(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void Pantalla::eventoRegistrado(const QString & _t1)
{
