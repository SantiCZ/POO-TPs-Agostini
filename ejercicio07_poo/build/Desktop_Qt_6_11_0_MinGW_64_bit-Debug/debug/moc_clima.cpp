...
template <> constexpr inline auto Clima::qt_create_metaobjectdata<qt_meta_tag_ZN5ClimaE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "QNetworkReply*",
        "reply",
        "onActualizacionPeriodica",
        "onSinConexion"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'climaActualizado'
        QtMocHelpers::SignalData<void(double, const QString &, const QString &, const QString &, int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Double, 3 }, { QMetaType::QString, 4 }, { QMetaType::QString, 5 }, { QMetaType::QString, 6 },
            { QMetaType::Int, 7 },
        }}),
        // Signal 'errorClima'
...
void Clima::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->climaActualizado((*reinterpret_cast<std::add_pointer_t<double>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[4])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[5]))); break;
        case 1: _t->errorClima((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->onRespuestaClima((*reinterpret_cast<std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 3: _t->onActualizacionPeriodica(); break;
        case 4: _t->onSinConexion(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Clima::*)(double , const QString & , const QString & , const QString & , int )>(_a, &Clima::climaActualizado, 0))
            return;
...
// SIGNAL 0
void Clima::climaActualizado(double _t1, const QString & _t2, const QString & _t3, const QString & _t4, int _t5)
{
